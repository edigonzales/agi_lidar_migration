...
def DATA_FOLDER = USER_HOME + "/tmp/geodata/ch.bl.agi.lidar_2018.dtm.gpkg_tmp/"
def TINDEX = "../data/2018/tindex.shp"
def TEMP_FOLDER = USER_HOME + "/tmp/geodata/tmp/"
def XTF_FOLDER = USER_HOME + "/tmp/geodata/ch.bl.agi.lidar_2018_contour1m.xtf/"
def GPKG_FOLDER = USER_HOME + "/tmp/geodata/ch.bl.agi.lidar_2018_contour1m.gpkg/"
def DXF_FOLDER = USER_HOME + "/tmp/geodata/ch.bl.agi.lidar_2018_contour1m.dxf/"
