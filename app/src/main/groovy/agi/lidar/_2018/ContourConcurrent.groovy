...
def PERIMETER = "../data/2018/perimeter5m.gpkg"
def TINDEX = "../data/2018/tindex.shp"
def DATA_FOLDER = USER_HOME +  "/tmp/geodata/ch.bl.agi.lidar_2018.dtm/"
def RESULT_FOLDER = USER_HOME + "/tmp/geodata/ch.bl.agi.lidar_2018.dtm.gpkg_tmp/"
